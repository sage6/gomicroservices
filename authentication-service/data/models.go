...
// New is teh function used to create an instance of the data package. It returns the type
// Model, which embeds all teh types we want to be avilable to our application
...
// app variable is used, provided that the modle is also added in the New function.
type Models struct {
	User User
}
...
// GetAll returns a slice of all users, stored by last name
...
// Update uupdates one user in the database, using the information
